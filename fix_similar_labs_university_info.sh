...
echo "🔧 類似研究室の大学情報取得を修正中..."

# 1. バックエンドAPI修正 - labs.pyの類似研究室APIを大学情報付きで修正
echo "📝 backend/app/api/endpoints/labs.py を修正中..."
...
# 2. フロントエンドAPI修正 - モックデータも改善
echo "📝 frontend/src/utils/api.ts を修正中..."
...
# 3. LabCard.tsx も大学情報表示を改善
echo "📝 frontend/src/components/LabCard.tsx を修正中..."
...
echo ""
echo "📋 修正内容:"
echo "  ✅ バックエンドAPI: 類似研究室取得時に大学情報をJOINで確実に取得"
echo "  ✅ ResearchLabSearchResult型での大学情報の確実な設定" 
echo "  ✅ フロントエンドAPI: モックデータの大学情報を現実的な内容に改善"
echo "  ✅ LabCard: 大学情報の安全な表示処理を改善"
echo ""
echo "🔍 期待される変化:"
echo "  「大学名未設定」→「京都大学」「東京大学」「大阪大学」"
echo "  「地域未設定」→「京都府」「東京都」「大阪府」"
echo "  より現実的な研究室情報の表示"
echo ""
echo "🚀 確認方法:"
echo "1. docker-compose restart backend  # バックエンド再起動"
echo "2. ブラウザで研究室詳細画面の類似研究室セクションを確認"
echo "3. 正しい大学名・地域が表示されることを確認"